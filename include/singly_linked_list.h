...
//   } MyItem;
//
//   void PrintMyItem(SLLNode *n) {
//     MyItem *item = container_of(n, MyItem, node);
//     printf("%d", item->value);
//   }
//
//   MyItem a = {.value = 10}; // or you can start with an empty list
//                             // see /src/main.c for examples
//   SLLNode *head = NULL;
//   SLLAppend(&head, &a.node);
//   SLLNodes(head, PrintMyItem);
